...
import com.example.iniciojsonkot.Frag1K
import com.example.iniciojsonkot.Frag2K
import com.example.iniciojsonkot.Frag3K
...
*/
    ...
    fun loadDataFromGit(){
        spells = MainActivity.DownloadGit().execute("https://raw.githubusercontent.com/TheGiddyLimit/TheGiddyLimit.github.io/master/data/spells/spells-phb.json").get()
        basicitems = MainActivity.DownloadGit().execute("https://raw.githubusercontent.com/TheGiddyLimit/TheGiddyLimit.github.io/master/data/basicitems.json").get()
        items = MainActivity.DownloadGit().execute("https://raw.githubusercontent.com/TheGiddyLimit/TheGiddyLimit.github.io/master/data/items.json").get()
